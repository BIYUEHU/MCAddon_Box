...
var text = "{\"format_version\": \"1.16\",\"by\":\"本包使用MCAddonBox制作\",\"minecraft:recipe_brewing_container\": {\"description\": {\"identifier\": \"" + ui.ID.text() + "\" },  \"tags\": [\"brewing_stand\"],\"input\": \"" + ui.shuru.text() + "\",\"reagent\": \"" + ui.yuanliao.text() + "\",\"output\": \"" + ui.shuchu.text() + "\" } }"
