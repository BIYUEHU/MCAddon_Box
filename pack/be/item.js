...
ui.layout(
    ...
    <vertical>          
         <text textSize="20sp" />
         <text text="生成items行为文件" textColor="yellow" textSize="24sp"/>
         <text textSize="15sp" />
...
var lujing = "/sdcard/games/.byh.MCAddonBox/pack/be/items/" + ui.wj.text() + ".json";


files.ensureDir(lujing);

var text = "{\"format_version\":\"1.16\",\"by\":\"本包使用MCAddonBox制作\",\"minecraft:item\":{\"description\":{\"identifier\":\"" + ui.ID.text() + "\"},\"components\":{\"minecraft:hand_equipped\":" + ui.hand_equipped.checked + ",\"minecraft:stacked_by_data\":" + ui.stacked_by_data.checked + ",\"minecraft:foil\":" + ui.foil.checked + "}}}"
