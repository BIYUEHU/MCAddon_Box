...
ui.layout(
    ...
    <vertical>          
         <text textSize="20sp" />
         <text text="生成blocks行为文件" textColor="yellow" textSize="24sp"/>
         <text textSize="15sp" />
...
var lujing = "/sdcard/games/.byh.MCAddonBox/pack/be/blocks/" + ui.wj.text() + ".json";

files.ensureDir(lujing);

var text = "{\"format_version\":\"1.16\",\"by\":\"本包使用MCAddonBox制作\",\"minecraft:block\":{\"description\":{\"identifier\":\"" + ui.ID.text() + "\",\"register_toeative_menu\":" + ui.menu.checked + ",\"is_experimental\":false},\"components\":{\"minecraft:destroy_time\":" + ui.destroy_time.text() + ",\"minecraft:block_light_absorption\":" + ui.block_light_absorption.text() + ",\"minecraft:block_light_emission\":" + ui.block_light_emission.text() + ",\"minecraft:map_color\":\"" + ui.map_color.text() + "\",\"minecraft:explosion_resistance\":" + ui.explosion_resistance.text() + ",\"minecraft:friction\":" + ui.friction.text() + ",\"minecraft:flammable\":" + ui.flammable.text() + "}}}"
