...
ui.layout(
    ...
    <vertical>          
         ...
         <text text="切石机" textColor="black" textSize="22sp"/>
         <text textSize="15sp" />
         ...
         <text text="权重" textColor="black" textSize="20sp" />
         <input id="qz" hint="该配方在切石机UI内的排列顺序，1最前"/>
...
var text = "{\"format_version\":\"1.16\",\"by\":\"本包使用MCAddonBox制作\",\"minecraft:recipe_shapeless\":{\"description\":{\"identifier\":\"" + ui.ID.text() + "\"},\"tags\":[\"stonecutter\"],\"priority\":" + ui.qz.text() + ",\"ingredients\":[{\"item\":\"" + ui.shuru.text() + "\"}],\"result\":{\"item\":\"" + ui.shuchu.text() + "\"}}}"
