...
ui.layout(
    ...
    <vertical>          
         <text textSize="20sp" />
         <text text="生成manifest资源文件" textColor="yellow" textSize="24sp"/>
         <text textSize="15sp" />
...
var text = "{\"format_version\":1,\"by\":\"本包使用MCAddonBox制作\",\"header\":{\"name\":\"" + ui.name.text() + "\",\"description\":\"" + ui.jieshao.text() + " 作者 " + ui.by.text() + " 本包使用MCAddonBox制作\",\"uuid\":\"" + uuid() + "\",\"version\":[" + ui.v1.text() + "," + ui.v2.text() + "," + ui.v3.text() + "]}," + "\"modules\":[{\"description\":\"" + ui.jieshao.text() + "\",\"type\":\"" + "resources" + "\",\"uuid\":\"" + uuid() + "\",\"version\":[" + ui.v1.text() + "," + ui.v2.text() + "," + ui.v3.text() + "]" + "}]}";
